class EventController < ApplicationController
  before_action only: [:index, :list, :edit, :update, :destroy]
	...
	def event_params
	  params.require(:event).permit(:game_year, :pitch_id_two, :batter, :pitcher, :pitch_type, :game_id, :batter_name, :pitcher_name, :pitch_hand, :bat_side)
	end

	def filtering_params(params)
		params.slice(:game_year, :pitch_id_two, :batter, :pitcher, :pitch_type, :game_id, :batter_name, :pitcher_name, :pitch_hand, :bat_side)
	end
